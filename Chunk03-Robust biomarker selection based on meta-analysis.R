...
################################################################################
### A nested meta-analysis based on multiple random samples used for rubust 
### biomarker selection, Apr. 26th, 2020.
### Author: Bo Li, Huachun Yin.
################################################################################

### Title: A novel meta-analytical approach to improve identification of differentially 
### expressed genes from transcriptomics data
